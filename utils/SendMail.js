                ...
                <td align="center">
                    <table width="600" cellpadding="0" cellspacing="0"
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <h4 style="font-size:22px; font-weight:700; margin:0 0 10px; color:#444a64;"> Hi ${data.userName},</h4>
                                    <p style="font-size:17px; font-weight:400; margin:15px 15px 20px; color:#69767A; line-height: 24px;">
                                        We’re excited to have you on board and appreciate your trust in our services.
                                        Your subscription has been successfully activated.</p>
                                        <p  style=" text-align:center; color:#444a64; font-size:15px; font-weight: 600; padding:5px 0px 0px ;">You can view and download your invoice using the link below:</p>
                                    <div> <a href=${link} target="_blank"
                                            style="display:inline-block; background:#ff9c4a; color:#fff; padding:12px 24px; border-radius:30px; text-decoration:none; font-weight:bold; font-size:16px;">View Invoice</a></div>
                                    <p style="font-size:15px; font-weight:400; color:#69767A; margin:20px 0 20px; line-height: 24px;">
                                        If you have any questions or need assistance, please contact our support team at your convenience.
                                        Thanks again, and welcome to the PixaScore community!</p>
                                </td>
                            </tr>
                        </tbody>
                        <tfoot>
...
export const sendEmail = async (type, to, subject, link, data = null) => {
    let mailHtml = '';
    ...
    switch (type) {
        ...
        case 'verifyEmail':
            ...
            break;
        case 'subscriptionMail':
            mailHtml = mailType.subscriptionMail(link, data);
            if (!link) {
                throw new Error('Invoice Link is required for subscription mail');
            }
            break;
        default:
